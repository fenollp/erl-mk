...
* **erlang.mk** had too many [quirks](//github.com/extend/erlang.mk/issues/21) and uses too many shell code & loops (ie slow again)
...
* Support the whole OTP arch (eg. `lib/`, …)
* Fix `make -j` support
...
# Contact
Please [report issues](//github.com/fenollp/erl-mk/issues) and do a lot of [Pull Requests](//github.com/fenollp/erl-mk/pulls).
